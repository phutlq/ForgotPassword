...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForgotPassword.setTittleText(Constant.TITTLE_TEXT);
        mForgotPassword.setForgotText(Constant.FORGOT_TEXT);
        ...
        mForgotPassword.setButtonForgotText(Constant.BUTTON_FORGOT_TEXT);
